<template>
    <div style="backgroundImage: url('/xinwenzixunxitong/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">新闻资讯系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="自媒体人姓名" class="input" v-if="tableName=='zimeitiren'">
                            <el-input v-model="ruleForm.zimeitirenName" autocomplete="off" placeholder="自媒体人姓名"  />
                        </el-form-item>
                        <el-form-item label="自媒体人手机号" class="input" v-if="tableName=='zimeitiren'">
                            <el-input v-model="ruleForm.zimeitirenPhone" autocomplete="off" placeholder="自媒体人手机号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='zimeitiren'">
                            <el-input v-model="ruleForm.zimeitirenEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.zimeitirenName)&& 'zimeitiren'==this.tableName){
                                this.$message.error('自媒体人姓名不能为空');
                                return
                            }
                             if('zimeitiren' == this.tableName && this.ruleForm.zimeitirenPhone&&(!this.$validate.isMobile(this.ruleForm.zimeitirenPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('zimeitiren' == this.tableName && this.ruleForm.zimeitirenEmail&&(!this.$validate.isEmail(this.ruleForm.zimeitirenEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                this.$http({
