    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="自媒体人姓名" prop="zimeitirenName">
                       <el-input v-model="ruleForm.zimeitirenName"
                                 placeholder="自媒体人姓名" clearable  :readonly="ro.zimeitirenName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="自媒体人手机号" prop="zimeitirenPhone">
                       <el-input v-model="ruleForm.zimeitirenPhone"
                                 placeholder="自媒体人手机号" clearable  :readonly="ro.zimeitirenPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="zimeitirenEmail">
                       <el-input v-model="ruleForm.zimeitirenEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.zimeitirenEmail"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="电子邮箱" prop="zimeitirenEmail">
                           <el-input v-model="ruleForm.zimeitirenEmail"
        ...
        data() {
            return {
                ...
                ro:{
                    username: false,
                    password: false,
                    zimeitirenName: false,
                    zimeitirenPhone: false,
                    zimeitirenPhoto: false,
                    sexTypes: false,
                    zimeitirenEmail: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                ...
                rules: {
                   ...
                   zimeitirenName: [
                              { required: true, message: '自媒体人姓名不能为空', trigger: 'blur' },
                          ],
                   zimeitirenPhone: [
                              {  required: true, message: '自媒体人手机号不能为空', trigger: 'blur' },
                   ...
                   zimeitirenPhoto: [
                              { required: true, message: '自媒体人头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`zimeitiren/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.zimeitirenCrossAddOrUpdateFlag = false;
                                        this.parent.search();
