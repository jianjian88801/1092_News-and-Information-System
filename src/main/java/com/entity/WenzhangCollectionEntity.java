...
public class WenzhangCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public WenzhangCollectionEntity() {

	}

	public WenzhangCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "WenzhangCollection{" +
            "id=" + id +
            ", wenzhangId=" + wenzhangId +
            ", yonghuId=" + yonghuId +
            ", wenzhangCollectionTypes=" + wenzhangCollectionTypes +
